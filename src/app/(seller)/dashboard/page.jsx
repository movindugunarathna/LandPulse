...
<<<<<<< Updated upstream
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400 hover:font-semibold"><Link href="">Edit Profile</Link> </span>
          </div>
          ...
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg my-4 p-2">
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <caption className="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                    History
                    <p className="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">All your products are here. </p>
                </caption>
                <thead className="text-xs text-gray-500  bg-gray-200 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" className="px-6 py-3 rounded-s-lg text-gray-700 ">
                            Title
                        </th>
                ...
                <tbody>
                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td className="px-6 py-4 text-right text-gray-900 whitespace-nowrap dark:text-white">
                            <a href="#" className="font-medium text-white dark:text-white bg-lime-700 px-3 py-1 rounded-sm hover:bg-lime-800">Edit</a>
                        </td>
                        <td className="px-6 py-4 text-center">
                          <svg className="hover:text-gray-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
