          ...
          <div className="relative flex h-16 items-center justify-start">
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              <div className="flex flex-shrink-0 items-center">
                <a href="/">
                  <Image className="h-8 w-auto" src="/logo.png" width={500} height={500} alt="" />
                </a>
              </div>
              <div className="hidden sm:ml-auto sm:block">
                <div className="flex space-x-5">
                  ...
                  <Link href="/viewAll" className="text-black-300 hover:bg-white-700 hover:text-lime-600 rounded-md px-3 py-2 text-sm font-medium">
                    ADVERTISEMENTS
                  </Link>
