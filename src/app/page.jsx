          ...
          <div className="relative z-10 flex flex-col justify-center items-center h-full text-center text-white">
            ...
            <div className="container text-wrap text-xs leading-relaxed">
              <p className="mt-4 text-2xl md:text-lg">
                ...
                waterfronts each plot holds the promise of your vision. Begin your journey here, where land becomes a space for your creativity to flourish and your dreams to take shape.
              </p>
            </div>
            <div className="">
        ...
        <div class="w-full max-w-6xl">
          <div class="mt-10">
            ...
            <p class="mt-5 text-justify">
              ...
              ready to be shaped according to your desires. Whether it's a serene retreat enveloped by nature's embrace or a bustling expanse primed for innovation, our diverse array of land listings
              caters to every aspiration. Unearth the ideal backdrop for your dreams, where endless horizons meet limitless potential. Begin your exploration today and discover the space that
          ...
          <div class="flex items-center justify-center h-20 space-x-2">
            <button class="bg-custom-green-100 hover:bg-lime-900 text-white font-bold py-2 px-4 rounded">Next</button>
          </div>
        </div>
      </section>
