...
export default function PriceSection({ setPriceDetails, priceDetails }) {
    ...
    return (
        <div
            className="absolute top-0 left-0 m-0 p-0 w-screen h-screen bg-white flex justify-center items-center "
            onClick={handleClick}
        >
            <div className="w-2/3 h-2/3 bg-white rounded-md border border-black z-10 ">
                ...
                >
                    <div className=" absolute top-0 left-0 w-full h-fit justify-center">
                    ...
                    <div className="py-8 overflow-y-scroll overflow-x-hidden w-full h-full">
                        {isPricePredict ? <PredictPrice /> : <InputPrice />}
                    </div>

                    <div className=" absolute bottom-0 left-0 w-full h-fit text-center p-4 px-8 flex justify-between items-center">
                        <input
                            type="button"
